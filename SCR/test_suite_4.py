...
if __name__ == "__main__":
    ...
    if response == 'yes':
        ...
        print("  [OK] EXCEPTIONAL statistical precision (+/-0.019% margin of error)")
        print("  [OK] Regional stratification matching global HIV epidemiology")
        print("  [OK] Population-specific insights for health equity")
        print("  [OK] Policy-ready recommendations for WHO/UNAIDS")
        print("  [OK] Publication-ready evidence for top-tier journals")
        print()
        print("Next steps:")
