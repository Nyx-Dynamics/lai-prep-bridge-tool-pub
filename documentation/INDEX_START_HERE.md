...
**What's Inside**:
- What the tool is and what it can do
...
- Adding Tool to existing PrEP program
- Grant incorporation
- Training new staff
- Quality improvement projects

**Phases**:
- ✓ **Phase 1** (Week 1): Oral to Injectabe PrEP Switches
...
### 7. **lai_prep_decision_tool.py** 
**Format**: Python executable code
...
- Patient navigation literature (10-40% improvement in primary and cross therapeutic area literature)
...
**Based on**: Demidont (2025). Bridging the Gap. *Viruses*.  
**Contact**: acdemidont@nyxdynamics.org

**All resources available at**: \textbf{Zenodo database}:\url{https://zenodo.org/uploads/17727117#:~:text=10.5281/zenodo.17727117}
